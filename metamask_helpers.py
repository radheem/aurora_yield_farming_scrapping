...
EXTENSION_PATH = "/home/radheem/github/selfhelp/metamaskExtension.crx"
...
def launchSeleniumWebdriver(driverPath):
    print(driverPath,EXTENSION_PATH)
...
def add_network():
    ...
    # driver.find_element_by_class_name('button btn-primary btn--rounded').click()
    driver.find_element_by_xpath('//*[@id="app-content"]/div/div[3]/div/div[2]/div[2]/button[2]').click()
    time.sleep(3)
    print('network added and switched')
